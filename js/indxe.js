...
function createWell(bookmark) {
    ...
    var link = "<a class=\"btn btn-primary w-auto mx-4  shadow-lg my-3\" href=\"" + bookmark.url + "\" target=\"_blank\">visit</a>"; 
    var btndelete = "<button class=\"btn btn-danger mx-4 w-auto shadow-lg my-3 btndelete\">Delete</button>"; 
